...
#define DBG_TCP			    DBG_LEVEL_ERROR		// 调试开关
//#define DBG_TCP			    DBG_LEVEL_ERROR      // DBG_LEVEL_ERROR		// 调试开关

#define NET_ENDIAN_LITTLE       1                   // 系统是否为小端

#define EXMSG_MSG_CNT          10                 // 消息缓冲区大小

#define PKTBUF_LOCK_INT         1                   // 是否使用中断锁
#define PKTBUF_BLK_SIZE         512                 // 数据包块大小
#define PKTBUF_BLK_CNT          50                 // 数据包块的数量
#define PKTBUF_BUF_CNT          50                 // 数据包的数量

#define NETIF_USE_INT                   1           // 网络接口使用中断保护
#define NETIF_HWADDR_SIZE               8                  // 硬件地址长度，mac地址最少6个字节
#define NETIF_NAME_SIZE                 8                  // 网络接口名称大小
#define NETIF_DEV_CNT                   2                   // 网络接口的数量
#define NETIF_INQ_SIZE                  10                  // 网卡输入队列最大容量
#define NETIF_OUTQ_SIZE                 10                  // 网卡输出队列最大容量

#define TIMER_NAME_SIZE             16              // 定时器名称长度
#define TIMER_SCAN_PERIOD           50             // 定时器列表扫描周期

#define ARP_CACHE_SIZE					5 // 50              // ARP表项大小
...
#define DNS_SERVER_MAX                  8           // 最大支持的DNS服务器表项数量
#define DNS_ENTRY_SIZE                  4          // DNS表项的数量
#define DNS_DOMAIN_NAME_MAX             32          // DNS中域名的长度
#define DNS_PORT_DEFAULT                53          // 缺省的DNS端口
#define DNS_QUERY_RETRY_TMO             5           // DNS查询超时
#define DNS_QUERY_RETRY_CNT             5           // 查询超时重试次数
#define DNS_WORKING_BUF_SIZE            256         // 工作缓存大小 

#define TCP_MAX_NR					    9		    // TCP控制块的数量
#define TCP_SBUF_SIZE                   4096       // TCP发送缓冲区大小
//#define TCP_RBUF_SIZE                   64240        // 接收缓冲区大小
#define TCP_RBUF_SIZE                   512        // 接收缓冲区大小
...
#define TCP_FREE_DELAYED_TMO            5000           // TCP关闭延时释放的时间
