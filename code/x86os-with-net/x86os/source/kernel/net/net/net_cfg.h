...
// 调试信息输出
#define DBG_MBLOCK		    DBG_LEVEL_NONE			// 内存块管理器
#define DBG_QUEUE           DBG_LEVEL_NONE          // 定长存储块
#define DBG_MSG             DBG_LEVEL_NONE          // 消息通信
#define DBG_BUF             DBG_LEVEL_NONE          // 数据包管理器
#define DBG_PLAT            DBG_LEVEL_NONE          // 系统平台
#define DBG_INIT            DBG_LEVEL_NONE          // 初始化模块
#define DBG_NETIF           DBG_LEVEL_NONE          // 网络接口层
#define DBG_ETHER           DBG_LEVEL_NONE          // 以太网协议层
#define DBG_TOOLS           DBG_LEVEL_NONE          // 工具集
#define DBG_TIMER           DBG_LEVEL_NONE         // 定时器
#define DBG_ARP             DBG_LEVEL_NONE          // ARP协议
#define DBG_IP			    DBG_LEVEL_NONE          // 调试开关
#define DBG_ICMP			DBG_LEVEL_NONE			// 调试开关
#define DBG_DNS             DBG_LEVEL_NONE              // DNS调试开关
#define DBG_RAW			    DBG_LEVEL_NONE         // 调试开关
#define DBG_UDP			    DBG_LEVEL_NONE			// 调试开关
#define DBG_SOCKET		    DBG_LEVEL_NONE			// 调试开关
#define DBG_TCP			    DBG_LEVEL_NONE		// 调试开关
...
#define PKTBUF_BLK_SIZE         64                 // 数据包块大小
...
#define TCP_SBUF_SIZE                   20480       // TCP发送缓冲区大小
